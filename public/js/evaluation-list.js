...
document.querySelector(".topbar .admin-box").style.display = "none";
...
async function searchReports() {
    ...
    const response = await fetch(
        `/api/evaluation/filter?schoolId=${schoolId}&className=${className}&subject=${encodeURIComponent(subject)}`
    );
